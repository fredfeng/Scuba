...
public class StringUtil {
	...
	public static void reportSec(String desc, long start, long end) {
		...
		System.out.println("[Performance] " + desc + " in " + difference
				+ " ms.");
	}

	public static void reportSec(String desc, long time) {
		double difference = time / 1e6;
		System.out.println("[Performance] " + desc + " in " + difference
				+ " ms.");
	}

	public static void reportTotalTime(String desc, double time) {
		System.out.println("[Performance] " + desc + " in " + (time / 1e6)
				+ " ms.");
	}
