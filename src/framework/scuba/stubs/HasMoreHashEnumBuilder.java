...
/**
 * Stub for method "boolean hasMoreElements()" in
 * class hasMoreElements:()Z@java.security.PermissionsEnumerator.
 * 
 * @author Yu Feng (yufeng@cs.utexas.edu)
 */
public class HasMoreHashEnumBuilder implements ICFGBuilder {
	@Override
